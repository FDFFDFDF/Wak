...
if __name__ == '__main__':   
    ...
    def main_(arg, opt_str):
        ...
        try:
            ...
            isVPN = arg[opt_str]['isVPN']            
            TAPI.proxy = isVPN
            NCCG.TAPI.proxy = isVPN
            ...
            if not TAPI.boo:         
                ...
                make_config_file(config_file, arg[opt_str]['YTMake'], arg[opt_str]['YTUpload'], arg[opt_str]['isVPN'], opt_str)
            ...
            RCLD.Run(folder_by_streamer, isBrowser = False, isVPN = isVPN)
