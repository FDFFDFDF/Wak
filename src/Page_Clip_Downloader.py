...
filehandler = logging.FileHandler('logfile_{:%Y%m%d-%H_%M_%S}.log'.format(datetime.datetime.now()), encoding='utf-8')
    ...
    try:
        ...
        if not os.path.exists(Clip_file):
            ...
            for Page_Address in Page_Address_list:
                ...
                # 결과 배열 생성
                Naver_res_lists.append([naver_title, Clip_links])
                #print(Clip_links)
        ...
        ## 클립 주소 파일이 존재할 시 불러오기
            ...
            Naver_res_lists.pop(-1)   #마지막 쓸모없는 데이터 빼기
        ...
        for Naver_res_list in Naver_res_lists:
            ...
            for Clip_link in Naver_res_list[1]:
                ...
                #Clip_link = 'https://clips.twitch.tv/EnergeticSoftNigiriKAPOW-3JdA5VHkr2JHOvEk'
                ...
                if driver.current_url.find('clip_missing')>=0:
                    logger.warning("!클립이 지워졌습니다 : " + Clip_link)
                    continue
